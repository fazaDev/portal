...
<body class="font-sans text-gray-800 bg-gray-50 dark:bg-putr-blue-dark dark:text-gray-200 transition-colors duration-300">
    ...
    <header class="bg-white shadow-md sticky top-0 z-50 dark:bg-putr-blue dark:border-gray-700 transition-colors duration-300">
        <div class="container mx-auto px-4 py-4 flex justify-between items-center">
            ...
            <nav class="hidden lg:flex gap-6 items-center">
                <a href="#" class="font-medium text-putr-blue hover:text-putr-yellow-dark border-b-2 border-transparent hover:border-putr-yellow transition py-1 dark:text-white dark:hover:text-putr-yellow">Beranda</a>
                ...
                <a href="#" class="font-medium text-putr-blue hover:text-putr-yellow-dark border-b-2 border-transparent hover:border-putr-yellow transition py-1 flex items-center gap-1 dark:text-white dark:hover:text-putr-yellow">Berita</a>
        ...
        <div id="mobile-menu" class="hidden lg:hidden bg-white border-t p-4 flex flex-col gap-2 shadow-lg dark:bg-putr-blue dark:border-gray-700">
            <a href="#" class="font-medium text-putr-blue py-2 border-b border-gray-100 dark:text-white dark:border-gray-700">Beranda</a>
            ...
            <a href="#" class="font-medium text-gray-600 py-2 border-b border-gray-100 dark:text-white dark:border-gray-700">Berita</a>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-xl transition group dark:bg-putr-blue">
                        ...
                        <div class="p-5">
                            ...
                            <h3 class="text-lg font-bold text-putr-blue-dark mb-2 leading-snug group-hover:text-putr-yellow-dark transition dark:text-gray-100"><a href="#">Pengecoran Jalan Lintas Timur Dilanjutkan Tahun Ini</a></h3>
                    ...
                    <div class="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-xl transition group dark:bg-putr-blue">
                        ...
                        <div class="p-5">
                            ...
                            <h3 class="text-lg font-bold text-putr-blue-dark mb-2 leading-snug group-hover:text-putr-yellow-dark transition dark:text-gray-100"><a href="#">Normalisasi Sungai Batanghari Masuk Tahap Perencanaan</a></h3>
